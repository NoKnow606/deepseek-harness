...
export const zh = {
  ...
  'image.dropDesc': '图片最多 {count} 张（每张 {size}）；其他文件单个不超过 32MB',
...
export const en = {
  ...
  'image.dropDesc': 'Up to {count} images ({size} each); other files up to 32MB each',
